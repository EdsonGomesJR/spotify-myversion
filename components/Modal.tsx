  ...
  return (
    <Dialog.Root open={isOpen} defaultOpen={isOpen} onOpenChange={onChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          className="fixed left-1/2 top-1/2 max-h-full w-full  -translate-x-1/2 
            -translate-y-1/2 rounded-md border border-neutral-700 bg-neutral-800
            p-[25px] drop-shadow-md 
            focus:outline-none md:h-auto md:max-h-[85vh] md:w-[90vw] md:max-w-[450px]"
        >
